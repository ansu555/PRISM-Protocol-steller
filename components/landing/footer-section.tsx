...
export function FooterSection() {
  ...
  return (
    <footer id="footer" ref={footerRef} className="relative mt-24 flex min-h-screen flex-col overflow-hidden bg-black lg:mt-32">
      {/* Panoramic banner image */}
      <div className={`relative mt-20 w-full h-[38vh] min-h-[300px] max-h-[440px] overflow-hidden transition-all duration-1000 lg:mt-24 ${
      ...
      <div className={`relative z-10 mx-auto flex w-full max-w-[1400px] flex-1 flex-col px-6 lg:px-12 transition-all duration-1000 delay-150 ${
        isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
      }`}>
        {/* Main Footer */}
        <div className="flex flex-1 items-end pb-12 pt-10 lg:pb-14 lg:pt-12">
          <div className="grid grid-cols-2 md:grid-cols-6 gap-8 lg:gap-8">
            {/* Brand Column */}
            <div className="col-span-2">
              <a href="#" className="inline-flex items-center gap-2 mb-6">
                <span className="text-2xl font-display text-white">PRISM</span>
        ...
        <div className="py-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/30">
            &copy; 2026 PRISM Protocol. All rights reserved.
          </p>
