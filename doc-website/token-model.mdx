...
PRISM tokenizes **risk exposure**, not individual loans, and does not introduce a protocol or governance token. The protocol issues tranche tokens; Soroswap pools may issue liquidity-provider tokens for secondary markets.
