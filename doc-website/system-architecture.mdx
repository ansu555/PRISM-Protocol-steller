...
| Risk & Market Layer | Provides liquidity and price discovery | Soroswap markets and market/NAV divergence |
...
![PRISM system architecture diagram](/images/system-architecture-diagram.svg)

## Design Philosophy

PRISM separates credit behavior into narrow, inspectable modules.

The vault should not need to know how a frontend visualizes risk. Soroswap should not be able to rewrite vault accounting. The dashboard should not create financial truth; it should read and explain the financial truth already committed on-chain.
...
8. Users either withdraw through the vault or trade tranche tokens through Soroswap pools.

## Accounting Boundary

The vault is the source of truth for intrinsic value. It tracks tranche assets, supply, and NAV. Soroswap is the source of market price. Its pools track reserves and swap pricing.
